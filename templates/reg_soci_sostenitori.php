...
if(isset($_POST) && count($_POST) > 0) {
    require_once("wp-content/themes/RetiSenzaFrontiere/lib/classes/register_user.php");
    global $wpdb;
    ...
    // $personal_data = $registration_form["personal_data"];
    // $residency = $registration_form["residency"];
    // $documents = $registration_form["documents"];
    // $contacts = $registration_form["contacts"];
    // $extra = $registration_form["extra"];
    // $survey = $extra["survey"];
    //
                                                ...
                                                <div class="col l6 m6 s10">
                                                    <div class="row">
                                                        <div class="input-field col l8 m9 s10">
                                                            <input id="reg_company" name="registration_form[personal_data][company]" type="text" data-error />
                                                            <label for="reg_company" class="required">Ragione sociale <span>*</span></label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col l4 m5 s6">
                                                            <input id="reg_vat_number" name="registration_form[personal_data][vat_number]" type="text" data-error />
                                                ...
                                                <div class="col l7 m8 s12">
                                                    <div class="row">
                                                        <div class="input-field col l6 m6 s12">
                                                            <input id="reg_name" name="registration_form[personal_data][name]" type="text" data-error />
                                                            <label for="reg_name" class="required">Nome <span>*</span></label>
                                                        </div>
                                                        <div class="input-field col l6 m6 s12">
                                                            <input id="reg_last_name" name="registration_form[personal_data][last_name]" type="text" data-error />
                                                    ...
                                                    <div class="row">
                                                        <div class="col l3 m4 s6">
                                                            ...
                                                            <input id="reg_birth_date" name="registration_form[personal_data][birth_date]" type="text" class="datepicker" />
                                                        </div>
                                                        <div class="input-field col offset-l3 offset-m2 l6 m6 s11">
                                                            <input id="reg_birth_place" name="registration_form[personal_data][birth_place]" type="text" data-error />
                                                ...
                                                <div class="col l7 m8 s12">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col l12 m12 s12">
                                                            <input id="reg_search_map" name="registration_form[residency][search_map]" type="text" data-error />
                                                            <label for="reg_search_map" class="required">Cerca...</label>
                                                        </div>
                                                    </div>
                                                    <input id="reg_map_data" name="registration_form[residency][map_data]" type="hidden" />
                                                    <div id="map"></div>
                                                    <div class="row">
                                                        <div class="input-field col l7 m7 s7">
                                                            <input placeholder="Via" id="reg_street" name="registration_form[residency][street]" type="text" data-error />
                                                        </div>
                                                        <div class="input-field col l2 m2 s4">
                                                            <input placeholder="Numero civico" id="reg_street_no" name="registration_form[residency][street_no]" type="text" data-error />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col l6 m6 s6">
                                                            <input placeholder="Città" id="reg_city" name="registration_form[residency][city]" type="text" data-error />
                                                        </div>
                                                        <div class="input-field col offset-l1 offset-m1 l3 m4 s5">
                                                            <input placeholder="CAP" id="reg_postal_code" name="registration_form[residency][postal_code]" type="text" maxlength="5" data-error />
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col l6 m6 s6">
                                                            <input placeholder="Provincia" id="reg_province" name="registration_form[residency][province]" type="text" data-error />
                                                        </div>
                                                        <div class="input-field col offset-l1 offset-m1 l5 m5 s6">
                                                            <input placeholder="Regione" id="reg_region" name="registration_form[residency][region]" type="text" data-error />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col l7 m8 s12">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col l6 m6 s10">
                                                            <input id="reg_fiscal_code" name="registration_form[documents][fiscal_code]" type="text" maxlength="16" data-error />
                                                            <label for="reg_name" class="required">Codice fiscale <span>*</span></label>
                                                        </div>
                                                        <div class="input-field col l6 m6 s10">
                                                            <input id="reg_identity_document" name="registration_form[documents][identity_document]" type="text" maxlength="9" data-error />
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col offset-l6 offset-m6 l6 m6 s12">
                                                            <input id="reg_released_by" name="registration_form[documents][released_by]" type="text" data-error />
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col offset-l6 offset-m6 l4 m5 s6">
                                                            ...
                                                            <input id="reg_released_date" name="registration_form[documents][released_date]" type="text" class="datepicker" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col l7 m8 s12">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col l5 m5 s10">
                                                            <input id="reg_telephone_number" name="registration_form[contacts][telephone_number]" type="text" />
                                                            <label for="reg_telephone_number">Numero di telefono</label>
                                                        </div>
                                                        <div class="input-field col offset-l1 offset-m1 l5 m5 s10">
                                                            <input id="reg_cellular_number" name="registration_form[contacts][cellular_number]" type="text" data-error />
                                                            <label for="reg_cellular_number" class="required">Numero di cellulare <span>*</span></label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col l10 m10 s12">
                                                            <input id="reg_email_address" name="registration_form[contacts][email_address]" type="email" data-error />
                                        ...
                                        <div id="payment" class="col s12 tab-content">
                                            <div class="row">
                                                <div class="col l7 m8 s12">
                                                    ...
                                                    <p>
                                                        <input type="checkbox" id="reg_net_member" name="registration_form[extra][net_membership_requested]" class="filled-in" />
                                                    ...
                                                    <div id="reg_net_member_why" class="indent-30" style="display: none;">
                                                        ...
                                                        <p>
                                                            <input type="checkbox" id="reg_net_member_no_connectivity" name="registration_form[extra][survey][no_connectivity]" class="filled-in" />
                                                            <label for="reg_net_member_no_connectivity">Non sono raggiunto da connettività</label>
                                                        </p>
                                                        <p>
                                                            <input type="checkbox" id="reg_net_member_only_tethering" name="registration_form[extra][survey][only_tethering]" class="filled-in" />
                                                            <label for="reg_net_member_only_tethering">È possibile navigare ma solo via GSM/UMTS (Telefono)</label>
                                                        </p>
                                                        <p>
                                                            <input type="checkbox" id="reg_net_member_low_connectivity" name="registration_form[extra][survey][low_connectivity]" class="filled-in" />
                                                            <label for="reg_net_member_low_connectivity">Sono raggiunto dagli operatori ma il servizio è scarso e/o inefficiente</label>
                                                        </p>
                                                        <p>
                                                            <input type="checkbox" id="reg_net_member_too_expensive" name="registration_form[extra][survey][too_expensive]" class="filled-in" />
                                                            <label for="reg_net_member_too_expensive">Sono raggiunto dagli operatori ma a costi troppo eccessivi per me</label>
                                                        </p>
                                                        <p>
                                                            <input type="checkbox" id="reg_net_member_no_satisfied" name="registration_form[extra][survey][no_satisfied]" class="filled-in" />
                                                        ...
                                                        <div class="row">
                                                            <div class="col l2 m2 s3">
                                                                <p>
                                                                    <input type="checkbox" id="reg_net_member_other" name="registration_form[extra][survey][other]" class="filled-in" />
                                                                    <label for="reg_net_member_other">Altro:</label>
                                                                </p>
                                                            </div>
                                                            <div class="col l10 m10 s9">
                                                                <input id="reg_net_member_other_reason" name="registration_form[extra][survey][other][reason]" type="text" placeholder="Motivo" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- <p>
                                                        <input class="with-gap" name="registration_form[payment_type" type="radio" id="reg_payment_sepa" checked="checked" />
                                                        <label for="reg_payment_sepa">Bonifico bancario</label>
                                                    </p>
                                                    <p>
                                                        <input class="with-gap" name="registration_form[payment_type" type="radio" id="reg_payment_paypal"  />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col l2 m2 s2">
                                                            <input id="reg_donation" name="registration_form[extra][declared_donation]" type="number" min="0" value="0" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="spacer-20"></div>
                                                    <p>
                                                        <input type="checkbox" id="reg_privacy_agree" name="registration_form[extra][privacy][agree]" class="filled-in" data-error />
                                                    ...
                                                    <p>
                                                        <input type="checkbox" id="reg_privacy_allow" name="registration_form[extra][privacy][allow]" class="filled-in" data-error />
                                                    ...
                                                    <!-- Button -->
                                                    <button id="registration_button" class="waves-effect waves-light btn green right" data-activate="save">

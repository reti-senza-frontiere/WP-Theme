...
function breadcrumb() {
    ...
    $home_title         = 'Home';
    $home_text          = '<span class="fa fa-home"></span>';
    ...
    if(!is_front_page()) {
        ...
        // Home page
        echo '<li class="item-home"><a class="bread-link bread-home" href="' . get_home_url() . '" title="' . $home_title . '">' . $home_text . '</a></li>';
